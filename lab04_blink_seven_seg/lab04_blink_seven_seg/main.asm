...
reset:
    ...
    ldi r16, $01        ;load r16 with a 1 in the bit 0 position
    out DDRA, r16       ;port A - bit 0 as an output
    ldi r16, $01        ;turn OFF digit driver
    out PORTA, r16
...
display:
	...
	call on_delay
	call on_delay
    ldi r16, $01        ;turn OFF digit
    out PORTA, r16
    call off_delay      ;timeout digit OF time
	call off_delay
	call off_delay
	call off_delay
	call off_delay
...
hextable: .db $01, $4F, $12, $06, $4C, $24, $60, $0F, $00
...
outer_loop:
    ldi r16, 255         ; 40 inner loop is about 123 us (called twice per period)
inner_loop:
    dec r16
    brne inner_loop
    dec r17
