...
prompt:
	call get_key_value						; get the value for the key
	cpi r18, $0C							; Check if the keypad is equal to ENTER
	breq convert_to_Packed_BCD				; Convert the value to packed BCD, if the keypad is equal to enter
	call store_value						; Store the value from the keypad in a register, this works if the key is NOT equal to ENTER
	call display_the_value					; Display the updated values to the LCD
	rjmp prompt								; Jump back to the prompt, this keeps happening until the key is equal to ENTER
...
convert_BCD_to_Binary:
	...
	sts burst_count_setting_bin, r19		; Store the value of r17 into burst_count_setting_bin
	sts burst_count_bin, r19				; Store the value of r17 into burst_count_bin
...
;**********************************************
display_the_value:
	call clr_dsp_buffs       ; clear all three buffer lines
	...
	call load_the_display	  ; Put the n = into the display buffer
