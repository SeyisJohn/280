...
service_keypad_input:
	...
	breq idiot							; goes to the beginning if the key value is equal to CLEAR
...
store_value_line_1:
	rcall get_key_value
	cpi r18, $0A							; if key value is not a number, end the subroutine.
	brlo skip_line_1
	ret
skip_line_1:
